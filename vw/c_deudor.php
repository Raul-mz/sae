...
?>
      ...
      <p><div class=" r col-md-offset-3"><h2>Deudor</h2></div> </p>
...
<div class="main col-sm-12 col-xs-  12 col-lg-10 col-md-10 col-md-offset-1">
                            ...
                            <thead><tr id="listar"><div align="right"><input class="btn btn-primary" type="submit" name="boton" onclick="nuevo('<?php echo 'r_'.$tabla?>')" value="Registrar" /></div>
                                        ...
                                        <tr id="listar">
                                          ...
                                          <th ><div align="center" class="t">Cedula/Pasaporte</div></th>
                                           <th width="10px"><div align="center" class="t">Nombre</div></th>
                                           <th ><div align="center" class="t">Dirección</div></th>
                                           <th width="10px"><div align="center" class="t">Telefono</div></th>
                                  ...
                                  <?php 
                                     ...
                                     <td><div align="center" class="ta"><?php  echo $r_Obt[$i]["direccion"]?> </div></td>
                                     <td><div align="center" class="ta"><?php  echo $r_Obt[$i]["telefono"]?> </div></td>
