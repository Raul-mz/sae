...
$r_Obt[0]['convenio_id']="";
  ...
  $r_Obt[0]['es_activo']="";
  $r_Obt[0]['monto_bruto']=0;
  $r_Obt[0]['interes']=0;
  $r_Obt[0]['interes_mora']=0;
  $r_Obt[0]['suttotal']=0;
  $r_Obt[0]['coactiva']=0;
  $r_Obt[0]['deuda_id']="";
  $r_Obt[0]['gasto_cobro']=0;
  $r_Obt[0]['total']=0;

 // $tabla="deuda";
//$ID="deudor_id";
 // $camp=$r_Obt[0]['deudor_id'];
//$r_Obt2 = $resultado->obtResultadoW($tabla,$ID,$camp);

  echo"<h2><p align='center'>Registrar Deuda</p> </h2>";
}
else {
  echo"<h2><p align='center'>Editar Deuda</p> </h2>";
  $camp=$_POST['id'];
                   ...
                   <form class="table-responsive" onsubmit="registrar('<?php echo $pag;?>'); return false">
                      <table class="table table-hover" height="100%">
                          ...
                          <tr>
                              ...
                              <td>
                                  <input type="hidden" class="form-control" id="campo" value="<?php echo $r_Obt[0]['deuda_id']?>">
